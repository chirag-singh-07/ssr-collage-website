...
export default function MScPage() {
  const highlights = [
    "Specialized focus on Organic Chemistry, Analytical Chemistry, and Microbiology",
    "Advanced research methodology and laboratory practice",
    "Opportunities for industrial training and internships",
    "Seminars and workshops by industry experts",
    "Preparation for NET/SET and Ph.D. entrance exams",
  ];
      ...
      <section className="relative w-full py-24 bg-[#0b4f81] overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <p className="text-xl text-white/80 max-w-2xl mx-auto leading-relaxed font-light animate-in slide-in-from-bottom duration-700 delay-100">
            Deepen your scientific knowledge. A postgraduate degree focused on
            research and advanced specialization.
          </p>
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-full inline-flex items-center gap-6 px-6 py-3 mt-8 animate-in slide-in-from-bottom duration-700 delay-200">
            ...
            <div className="flex items-center gap-2 text-white">
              ...
              <span className="text-sm font-semibold">30 Seats</span>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <section className="bg-white rounded-3xl p-8 shadow-sm border border-slate-100">
              ...
              <div className="prose prose-slate max-w-none text-slate-600 leading-relaxed">
                <p>
                  The Masters of Science (M.Sc) program at SSR College offers
                  specializations in Organic Chemistry and Microbiology. The
                  course is designed to provide advanced theoretical
                  understanding and rigorous practical training.
                </p>
                <p>
                  Students work on independent research projects and are
                  encouraged to publish their findings. The program prepares
                  graduates for careers in R&D, pharmaceuticals, quality
          ...
          <div className="lg:col-span-1 space-y-8">
            ...
            <div className="bg-[#0b4f81] rounded-3xl p-8 text-white relative overflow-hidden">
              ...
              <p className="text-white/80 mb-6 relative z-10 text-sm">
                Advance your research career. Apply now for the upcoming
                academic session.
              </p>
                ...
                <li>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500">Comp. Science</p>
                    </div>
                  </a>
                </li>
              </ul>
