...
export default function BComPage() {
  const highlights = [
    "Comprehensive coverage of Accounting, Finance, and Economics",
    "Focus on taxation, audit, and company law",
    "Preparation for professional exams like CA, CS, and CMA",
    "Internships with leading financial firms",
    "Training in modern accounting software (Tally, SAP)",
  ];
      ...
      <section className="relative w-full py-24 bg-[#0b4f81] overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <p className="text-xl text-white/80 max-w-2xl mx-auto leading-relaxed font-light animate-in slide-in-from-bottom duration-700 delay-100">
            Build a solid foundation in the world of finance, accounting, and
            economics. A gateway to professional success in commerce.
          </p>
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <section className="bg-white rounded-3xl p-8 shadow-sm border border-slate-100">
              ...
              <div className="prose prose-slate max-w-none text-slate-600 leading-relaxed">
                <p>
                  The Bachelor of Commerce (B.Com) at SSR College is a
                  traditional yet dynamic course aimed at providing students
                  with a deep understanding of business principles, accounting
                  practices, and economic policies.
                </p>
                <p>
                  It serves as an excellent foundation for professional courses
                  like Chartered Accountancy (CA), Company Secretary (CS), and
                  Cost Management Accounting (CMA). Students are trained to
                  handle financial complexities and understand the global
          ...
          <div className="lg:col-span-1 space-y-8">
            ...
            <div className="bg-[#0b4f81] rounded-3xl p-8 text-white relative overflow-hidden">
              ...
              <p className="text-white/80 mb-6 relative z-10 text-sm">
                Start your career in Commerce. Apply now for the upcoming
                academic session.
              </p>
              ...
              <ul className="space-y-4">
                ...
                <li>
                  <a
                    ...
                    className="group flex items-center gap-3 p-3 rounded-xl hover:bg-slate-50 transition-colors"
                  >
                    <div className="bg-rose-100 text-rose-600 p-2 rounded-lg group-hover:bg-[#0b4f81] group-hover:text-white transition-colors">
                      <BookOpen size={20} />
                    </div>
                    <div>
                      <h4 className="font-bold text-sm text-slate-700 group-hover:text-[#0b4f81]">
