...
export default function BScPage() {
  ...
  const curriculum = [
    ...
    },
    {
      year: "Year 3",
      subjects: [
        "Specialization Subject (Chem/Micro/Phy)",
        "Analytical Techniques",
        "Research Methodology",
        "Industrial Chemistry / Applied Micro",
        "Project Work",
      ...
      <section className="relative w-full py-24 bg-[#0b4f81] overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <p className="text-xl text-white/80 max-w-2xl mx-auto leading-relaxed font-light animate-in slide-in-from-bottom duration-700 delay-100">
            Explore the fundamental laws of nature. A comprehensive program
            fostering scientific inquiry and research.
          </p>
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-full inline-flex items-center gap-6 px-6 py-3 mt-8 animate-in slide-in-from-bottom duration-700 delay-200">
            ...
            <div className="flex items-center gap-2 text-white">
              ...
              <span className="text-sm font-semibold">120 Seats</span>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <section className="bg-white rounded-3xl p-8 shadow-sm border border-slate-100">
              ...
              <div className="prose prose-slate max-w-none text-slate-600 leading-relaxed">
                <p>
                  The Bachelor of Science (B.Sc) program offers a rigorous
                  education in core scientific disciplines. Students can major
                  in Chemistry, Microbiology, or Physics, gaining both
                  theoretical knowledge and practical laboratory skills.
                </p>
                <p>
                  <strong>Eligibility:</strong> An applicant who has passed
                  H.S.C Examination or an equivalent examination of any
                  statutory Board of University with Science as a subject is
                  eligible for admission to 1st year B.Sc. Degree course. Change
                  of subject once offered is not allowed, unless it is brought
                  to the notice of the authorities within 15 days of admission.
                </p>
              </div>
            </section>
          ...
          <div className="lg:col-span-1 space-y-8">
            ...
            <div className="bg-[#0b4f81] rounded-3xl p-8 text-white relative overflow-hidden">
              ...
              <p className="text-white/80 mb-6 relative z-10 text-sm">
                Start your scientific journey. Apply now for the upcoming
                academic session.
              </p>
                ...
                <li>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500">Science</p>
                    </div>
                  </a>
                </li>
                <li>
                  <a
                    href="/available-programmes/m-sc"
                    className="group flex items-center gap-3 p-3 rounded-xl hover:bg-slate-50 transition-colors"
                  >
