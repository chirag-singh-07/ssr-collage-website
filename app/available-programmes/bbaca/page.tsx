...
export default function BBACAPage() {
  const highlights = [
    "Integrated approach covering Management and Computer Applications",
    "Hands-on training in software development and database management",
    "Expertise in full-stack web development",
    "Industry-relevant certifications and workshops",
  ...
  const curriculum = [
    ...
    },
    {
      ...
      subjects: [
        ...
        "Practical Lab & Mini Project",
      ],
    },
    {
      year: "Year 3",
      subjects: [
        "Advanced Web Technologies (MERN/Java)",
      ...
      <section className="relative w-full py-24 bg-[#0b4f81] overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <p className="text-xl text-white/80 max-w-2xl mx-auto leading-relaxed font-light animate-in slide-in-from-bottom duration-700 delay-100">
            Bridge the gap between business management and technical expertise.
            A versatile degree for the digital age.
          </p>
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <section className="bg-white rounded-3xl p-8 shadow-sm border border-slate-100">
              ...
              <div className="prose prose-slate max-w-none text-slate-600 leading-relaxed">
                <p>
                  The BBA in Computer Applications (formerly BCA) is a
                  specialized program that combines the fundamentals of business
                  administration with technical computer skills. It is ideal for
                  students who aspire to manage IT projects or lead technical
                  teams.
                </p>
                <p>
                  The course covers a wide spectrum of subjects ranging from
                  software development and database management to financial
                  accounting and organizational behavior. Students graduate with
                  a unique blend of technical and managerial competencies.
                </p>
              </div>
            </section>
          ...
          <div className="lg:col-span-1 space-y-8">
            ...
            <div className="bg-[#0b4f81] rounded-3xl p-8 text-white relative overflow-hidden">
              ...
              <p className="text-white/80 mb-6 relative z-10 text-sm">
                Launch your career in IT Management. Apply now for the upcoming
                academic session.
              </p>
            ...
            <div className="bg-white rounded-3xl p-6 border border-slate-100 shadow-sm">
              ...
              <ul className="space-y-4">
                <li>
                  <a
                    href="/available-programmes/b-sc-computer-science"
                    className="group flex items-center gap-3 p-3 rounded-xl hover:bg-slate-50 transition-colors"
                  >
                    <div className="bg-purple-100 text-purple-600 p-2 rounded-lg group-hover:bg-[#0b4f81] group-hover:text-white transition-colors">
                      <BookOpen size={20} />
                    </div>
                    <div>
                      ...
                      <p className="text-xs text-slate-500">Pure Science</p>
                    </div>
                  </a>
                </li>
                <li>
                  <a
                    ...
                    className="group flex items-center gap-3 p-3 rounded-xl hover:bg-slate-50 transition-colors"
                  >
                    <div className="bg-blue-100 text-blue-600 p-2 rounded-lg group-hover:bg-[#ef5b2d] group-hover:text-white transition-colors">
                      <BookOpen size={20} />
                    </div>
                    <div>
                      <h4 className="font-bold text-sm text-slate-700 group-hover:text-[#0b4f81]">
                      ...
                      <p className="text-xs text-slate-500">General Mgmt</p>
                    </div>
                  </a>
                </li>
              </ul>
