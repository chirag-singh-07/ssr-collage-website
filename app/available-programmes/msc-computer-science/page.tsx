...
export default function MScComputerSciencePage() {
  const highlights = [
    ...
    "Advanced algorithms and data science techniques",
    "Research paper publication and seminar presentations",
      ...
      <section className="relative w-full py-24 bg-[#0b4f81] overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <p className="text-xl text-white/80 max-w-2xl mx-auto leading-relaxed font-light animate-in slide-in-from-bottom duration-700 delay-100">
            Advance your technical expertise and research capabilities. A
            postgraduate program for future tech innovators.
          </p>
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <section className="bg-white rounded-3xl p-8 shadow-sm border border-slate-100">
              ...
              <div className="prose prose-slate max-w-none text-slate-600 leading-relaxed">
                <p>
                  The Master of Science in Computer Science (M.Sc CS) is a
                  research-intensive program designed for students who wish to
                  deepen their understanding of complex computing systems.
                </p>
                <p>
                  Specializations include Artificial Intelligence, Data Science,
                  and Software Architecture. The course prepares students for
                  high-level R&D roles in the tech industry or academic careers.
                </p>
              </div>
            </section>
          ...
          <div className="lg:col-span-1 space-y-8">
            ...
            <div className="bg-[#0b4f81] rounded-3xl p-8 text-white relative overflow-hidden">
              ...
              <p className="text-white/80 mb-6 relative z-10 text-sm">
                Specialize in Computer Science. Apply now for the upcoming
                academic session.
              </p>
            ...
            <div className="bg-white rounded-3xl p-6 border border-slate-100 shadow-sm">
              ...
              <ul className="space-y-4">
                ...
                <li>
                  <a
                    href="/available-programmes/m-com"
                    className="group flex items-center gap-3 p-3 rounded-xl hover:bg-slate-50 transition-colors"
                  >
                    <div className="bg-rose-100 text-rose-600 p-2 rounded-lg group-hover:bg-[#ef5b2d] group-hover:text-white transition-colors">
                      <BookOpen size={20} />
                    </div>
                    <div>
                      <h4 className="font-bold text-sm text-slate-700 group-hover:text-[#0b4f81]">
                      ...
                      <p className="text-xs text-slate-500">Commerce PG</p>
                    </div>
                  </a>
                </li>
              </ul>
