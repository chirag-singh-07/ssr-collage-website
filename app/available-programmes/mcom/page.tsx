...
export default function MComPage() {
  const highlights = [
    "Specialization in Advanced Accounting and Taxation",
    "Focus on Corporate Finance and Governance",
    "Professional research and thesis work",
    "Preparation for roles in Banking, Finance, and Academics",
    "Seminars on GST and Financial Laws",
  ];
      ...
      <section className="relative w-full py-24 bg-[#0b4f81] overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <p className="text-xl text-white/80 max-w-2xl mx-auto leading-relaxed font-light animate-in slide-in-from-bottom duration-700 delay-100">
            Gain mastery over financial strategies and corporate governance. The
            definitive postgraduate degree for commerce professionals.
          </p>
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <section className="bg-white rounded-3xl p-8 shadow-sm border border-slate-100">
              ...
              <div className="prose prose-slate max-w-none text-slate-600 leading-relaxed">
                <p>
                  The Master of Commerce (M.Com) is a postgraduate degree
                  program focusing on advanced knowledge in commerce and
                  finance. It is ideal for students aspiring to become financial
                  analysts, auditors, or academic professionals.
                </p>
                <p>
                  The curriculum covers key areas such as Taxation, Corporate
                  Law, and Managerial Economics, enabling students to tackle
          ...
          <div className="lg:col-span-1 space-y-8">
            ...
            <div className="bg-[#0b4f81] rounded-3xl p-8 text-white relative overflow-hidden">
              ...
              <p className="text-white/80 mb-6 relative z-10 text-sm">
                Master the world of Finance. Apply now for the upcoming academic
                session.
              </p>
